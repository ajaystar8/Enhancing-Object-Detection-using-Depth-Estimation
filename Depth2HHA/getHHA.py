...
def getImage(idx, root):
    D = cv2.imread(os.path.join(root, 'depth', f'{idx}.png'), cv2.COLOR_BGR2GRAY) / 10000
    RD = cv2.imread(os.path.join(root, 'raw_depth', f'{idx}.png'), cv2.COLOR_BGR2GRAY) / 10000
    return D, RD
...
if __name__ == "__main__":
    ...
    print("HHA encodings generated successfully!")
