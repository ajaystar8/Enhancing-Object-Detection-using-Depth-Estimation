...
from models.resyolov3depth import ResYOLOv3
...
def main():
    ...
    train_loader, test_loader, train_eval_loader = get_loaders_nyu(mat_file_path=config.NYU_PATH, train_mode="fusion")
    load_checkpoint(
        os.path.join(".", "checkpoints", "depth_wise_loaded_weight_removed_low.pth.tar"), model, optimizer, config.LEARNING_RATE
    )
